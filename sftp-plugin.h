...
int call_read_plugins(uint32_t, const char *, uint64_t, uint32_t, enum PLUGIN_SEQUENCE);
int call_read_dir_plugins(uint32_t, const char *, enum PLUGIN_SEQUENCE);
int call_write_plugins(uint32_t, const char *, uint64_t, const char *, enum PLUGIN_SEQUENCE);
...
int call_fstat_plugins(uint32_t, const char *, uint32_t, enum PLUGIN_SEQUENCE);
int call_setstat_plugins(uint32_t, const char *, uint32_t, enum PLUGIN_SEQUENCE);
int call_fsetstat_plugins(uint32_t, const char *, uint32_t, enum PLUGIN_SEQUENCE);
